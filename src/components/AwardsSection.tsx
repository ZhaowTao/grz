  ...
  return (
    ...
    >
        ...
        {awards.map((a, i) => (
          <FadeIn key={a.title} delay={i * 0.05} y={24}>
            <div className="h-full rounded-3xl border border-[rgba(12,12,12,0.1)] bg-[#F6F7F9] p-6">
              ...
              <div className="text-[#0C0C0C]/55 text-sm">{a.note}</div>
            </div>
          </FadeIn>
        ))}
      </div>
      ...
      <div className="max-w-5xl mx-auto mt-12 sm:mt-16">
        <h3 className="text-[#0C0C0C]/70 font-semibold tracking-wide text-sm uppercase mb-5 sm:mb-7">
          校园经历 · Campus
        </h3>
            ...
            <FadeIn key={c.title} delay={i * 0.05} y={20}>
              <div className="flex gap-4 items-start rounded-2xl border border-[rgba(12,12,12,0.08)] p-5">
                ...
                <div>
                  ...
                  <div className="text-[#0C0C0C]/55 text-sm mt-1">{c.note}</div>
                </div>
              </div>
            </FadeIn>
          ))}
