export const profile = {
  ...
  tagline:
    "数据科学与大数据技术 2026 届应届毕业生（今年毕业），习惯用数据回答业务问题，也喜欢把想法做成真实可用的产品。",
  contact: {
    phone: "176-165-00107",
...
export const skills = [
  ...
  },
  {
    no: "03",
    title: "数据分析与建模",
    tags: ["Pandas", "Scikit-learn", "CatBoost / XGBoost / LightGBM", "Stacking", "RFECV", "SHAP", "SparkML"],
  },
  {
    no: "04",
    title: "数据可视化",
...
export const campus = [
  { title: "二进制联盟社团副社长", note: "带领 5 支队伍参加国家级竞赛，4 支获奖，获奖率 80%" },
  { title: "党务助理团宣传部部长", note: "统筹宣传策划与内容产出" },
  { title: "省级先进班集体 · 安全委员", note: "班级建设与安全事务管理" },
  { title: "青岛马拉松等大型活动志愿者", note: "赛会服务与现场协调" },
];
...
export const navLinks = [
  ...
  { label: "开源", href: "#opensource" },
  { label: "荣誉", href: "#honors" },
  { label: "教育", href: "#education" },
  { label: "联系", href: "mailto:dawntao07@163.com" },
];
